...
return {
  -- stylua: ignore start
	...
	fontXLarge         = { img = "assets/fonts/alagard.ttf",                  size = 96 },
	fontLarge          = { img = "assets/fonts/alagard.ttf",                  size = 48 },
	fontMed            = { img = "assets/fonts/alagard.ttf",                  size = 36 },
	fontSmall          = { img = "assets/fonts/alagard.ttf",                  size = 24 },
	fontXSmall         = { img = "assets/fonts/alagard.ttf",                  size = 16 },
	fontTiny           = { img = "assets/fonts/alagard.ttf",                  size = 12 },

	fontXLarge_alt     = { img = "assets/fonts/NormalFont.ttf",               size = 96 },
	fontLarge_alt      = { img = "assets/fonts/NormalFont.ttf",               size = 48 },
	fontMed_alt        = { img = "assets/fonts/NormalFont.ttf",               size = 36 },
	fontSmall_alt      = { img = "assets/fonts/NormalFont.ttf",               size = 24 },
	fontXSmall_alt     = { img = "assets/fonts/NormalFont.ttf",               size = 16 },
	fontTiny_alt       = { img = "assets/fonts/NormalFont.ttf",               size = 12 },
}
